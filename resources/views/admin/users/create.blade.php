        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('role_id', $roles, old('role_id'), ['class' => 'form-control select2', 'required' => '', 'id' => 'roleSelect']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row" id ='batchSelect'>
                    <div class="col-xs-12 form-group">
                        {!! Form::label('batch_id', 'Current Batch', ['class' => 'control-label']) !!}
