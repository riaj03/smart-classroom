...
class FoldersController extends Controller
{
    ...
    public function stdcourse($id)
    {
       
        $folder = DB::table('folders')->where('course_id', $id)->first();
        $files = \App\File::where('folder_id', $folder->id)->get();
        
        $posts = \App\Post::where('course_id', $id)->get();
        // dd($posts);
        return view('admin.folders.show', compact('folder', 'files', 'posts'));
    }
